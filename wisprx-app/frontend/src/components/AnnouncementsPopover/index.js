...
function AnnouncementDialog({ announcement, open, handleClose }) {
  const getMediaPath = (record) => {
    return record.mediaUrl || record.mediaPath || record;
  };
  return (
    <Dialog
      open={open}
    ...
    >
      ...
      <DialogContent>
        {(announcement.mediaUrl || announcement.mediaPath) && (
          <div
            style={{
              ...
              width: "400px",
              height: 300,
              backgroundImage: `url(${getMediaPath(announcement)})`,
