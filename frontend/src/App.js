    ...
    const theme = createTheme(
        {
            ...
            palette: {
                type: mode,
                primary: { main: mode === "light" ? "#00A86B" : "#FFFFFF" },
                textPrimary: mode === "light" ? "#00A86B" : "#FFFFFF",
                borderPrimary: mode === "light" ? "#00A86B" : "#FFFFFF",
                ...
                barraSuperior: mode === "light" ? "linear-gradient(to right, #00A86B,rgb(19, 180, 121) , #34C759)" : "#666",
